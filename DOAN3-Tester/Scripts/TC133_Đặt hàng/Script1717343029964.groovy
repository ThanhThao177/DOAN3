...
WebUI.setText(findTestObject('Object Repository/Page_Thanh ton - HappySkin Vit Nam/input__NewAddressForm.Phone'), '03456')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Thanh ton - HappySkin Vit Nam/select_Chn PhngXTh trn Quc OaiX Cn HuX Cng _020aa4'), 
    '', true)
...
WebUI.setText(findTestObject('Object Repository/Page_Thanh ton - HappySkin Vit Nam/input_Email_NewAddressForm.Email'), 'thao@gmail.')

WebUI.click(findTestObject('Object Repository/Page_Thanh ton - HappySkin Vit Nam/span_Thanh ton khi nhn hng'))

WebUI.click(findTestObject('Object Repository/Page_Thanh ton - HappySkin Vit Nam/button_Thanh ton 718.250  (CoD)'))
